...
const CartPageComponent = () => {
	...
	const getSubtitle = () => {
		...
		textCourse = courses.length ? `${courses.length} Course in cart` : '';
								...
								<HStack>
									...
									<Stack>
										...
										<HStack>
											...
											<Tag colorScheme={'facebook'}>{book.category}</Tag>
										</HStack>
									</Stack>
								</HStack>
								<Stack spacing={0}>
							...
							<Flex justify={'space-between'}>
								<HStack>
									...
									<Stack>
										...
										<Text>by {course.author.firstName + course.author.lastName}</Text>
										<HStack>
											<Tag colorScheme={'facebook'}>Course</Tag>
											<Tag colorScheme={'facebook'}>Paid</Tag>
										</HStack>
									</Stack>
								</HStack>
								<Stack spacing={0}>
